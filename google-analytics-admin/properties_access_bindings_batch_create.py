...
See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.accessBindings/batchCreate
for more information.
"""
# [START analyticsadmin_properties_access_bindings_batch_create]
...
def run_sample():
    ...
    batch_create_property_access_binding(property_id, email_address)


def batch_create_property_access_binding(
    property_id: str, email_address: str, transport: str = None
):
    """
    Creates a access binding for the Google Analytics 4 property using a batch
    call.
...
# [END analyticsadmin_properties_access_bindings_batch_create]
