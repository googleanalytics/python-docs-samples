...
"""Google Analytics Admin API sample application which delete the access binding for
the Google Analytics 4 property using a batch call.

See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.accessBindings/batchDelete
for more information.
"""
# [START analyticsadmin_properties_access_bindings_batch_delete]
...
def run_sample():
    ...
    batch_delete_property_access_binding(property_id, property_access_binding_id)


def batch_delete_property_access_binding(
    property_id: str, property_access_binding_id: str, transport: str = None
):
    """
    Deletes the GA4 property access binding using a batch call.
...
# [END analyticsadmin_properties_access_bindings_batch_delete]
