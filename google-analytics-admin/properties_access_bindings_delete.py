...
See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.accessBindings/delete
for more information.
"""
# [START analyticsadmin_properties_access_bindings_delete]
...
def run_sample():
    ...
    delete_property_access_binding(property_id, property_access_binding_id)


def delete_property_access_binding(
    property_id: str, property_access_binding_id: str, transport: str = None
):
    """
    Deletes the access binding from the Google Analytics 4 property.
...
# [END analyticsadmin_properties_access_bindings_delete]
