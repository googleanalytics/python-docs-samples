...
Analytics 4 property access binding.

See https://developers.google.com/analytics/devguides/config/admin/v1/rest/v1alpha/properties.accessBindings/update
for more information.
"""
# [START analyticsadmin_properties_access_bindings_update]
...
def run_sample():
    ...
    update_property_access_binding(property_id, property_access_binding_id)


def update_property_access_binding(
    property_id: str, property_access_binding_id: str, transport: str = None
):
    """
    Updates the Google Analytics 4 property access binding.
...
# [END analyticsadmin_properties_access_bindings_update]
